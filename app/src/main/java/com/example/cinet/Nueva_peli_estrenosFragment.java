...
public class Nueva_peli_estrenosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_nueva_peli_estrenos, container, false);
    }
    ...
    private void guardarEnFirestore(String titulo, String descripcion, String mediaUrl, String tipo, String productores, String reparto) {
        ...
        FirebaseFirestore.getInstance().collection("estrenos")
                .add(post)
